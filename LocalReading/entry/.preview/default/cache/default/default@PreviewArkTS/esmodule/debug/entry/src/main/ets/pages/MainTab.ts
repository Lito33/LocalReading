...
class MainTab extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("entry/src/main/ets/pages/MainTab.ets(13:5)", "entry");
            Tabs.vertical(false);
    ...
    tabBarBuilder(title: string, targetIndex: number, selectedIcon: Resource, unselectedIcon: Resource, parent = null) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/MainTab.ets(38:7)", "entry");
            Image.height(24);
            Image.width(24);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(title);
            Text.debugLine("entry/src/main/ets/pages/MainTab.ets(41:7)", "entry");
            Text.fontSize(10);
