...
class SyncSettings extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(53:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(54:7)", "entry");
            Row.width("100%");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/SyncSettings.ets(55:9)", "entry");
            Image.width(25);
            Image.height(25);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(63:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题
            Text.create('数据同步设置');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(67:9)", "entry");
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(75:9)", "entry");
            Blank.layoutWeight(1);
        }, Blank);
        Blank.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/SyncSettings.ets(81:7)", "entry");
            Scroll.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(82:9)", "entry");
            Column.width('100%');
    ...
    buildStatusCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(113:5)", "entry");
            Column.width('100%');
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(114:7)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Circle.debugLine("entry/src/main/ets/pages/SyncSettings.ets(116:9)", "entry");
            // 状态指示器
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('设备同步');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(120:9)", "entry");
            Text.fontSize(16);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(124:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.syncStatus.isSyncing ? '同步中...' : '就绪');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(126:9)", "entry");
            Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(133:7)", "entry");
            Row.width('100%');
            Row.margin({ bottom: 8 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('最后同步时间：');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(134:9)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(138:9)", "entry");
            Text.fontSize(14);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
            ...
            if (this.syncStatus.isSyncing) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Progress.debugLine("entry/src/main/ets/pages/SyncSettings.ets(147:9)", "entry");
                        Progress.width('100%');
                        Progress.height(4);
            ...
            if (this.syncStatus.syncError) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(157:9)", "entry");
                        Text.fontSize(12);
    ...
    buildDeviceInfo(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(175:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor(Color.White);
            Column.borderRadius(8);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(176:7)", "entry");
            Row.width('100%');
            Row.margin({ bottom: 12 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('跨设备同步');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(177:9)", "entry");
            Text.fontColor(Color.Black);
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(182:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('自动同步');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(184:9)", "entry");
            Text.fontSize(14);
            Text.fontColor('#666');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(191:7)", "entry");
            Column.width('100%');
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(192:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('同步用户数据');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(193:11)", "entry");
            Text.fontSize(16);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(197:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('账号、设置');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(199:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(206:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('同步设置');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(207:11)", "entry");
            Text.fontSize(16);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(211:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('字体、主题、亮度');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(213:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999');
        }, Text);
        Text.pop();
    ...
    buildSyncSettings(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(233:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor(Color.White);
            Column.borderRadius(8);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('同步设置');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(234:7)", "entry");
            Text.fontColor(Color.Black);
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Medium);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 自动同步开关
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(241:7)", "entry");
            // 自动同步开关
            Row.width('100%');
            // 自动同步开关
            Row.margin({ bottom: 12 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('自动同步');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(242:9)", "entry");
            Text.fontSize(16);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(246:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: this.autoSyncEnabled });
            Toggle.debugLine("entry/src/main/ets/pages/SyncSettings.ets(248:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // WiFi同步开关
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(264:7)", "entry");
            // WiFi同步开关
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('仅WiFi同步');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(265:9)", "entry");
            Text.fontSize(16);
            Text.fontColor('#333');
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(269:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: this.wifiOnlySync });
            Toggle.debugLine("entry/src/main/ets/pages/SyncSettings.ets(271:9)", "entry");
            Toggle.onChange((value: boolean) => {
    ...
    buildActionButtons(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(289:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SyncSettings.ets(291:7)", "entry");
            // 立即同步按钮
            Button.width('45%');
            // 立即同步按钮
            Button.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(303:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 恢复数据按钮
            Button.createWithLabel('恢复数据', { type: ButtonType.Normal });
            Button.debugLine("entry/src/main/ets/pages/SyncSettings.ets(306:7)", "entry");
            // 恢复数据按钮
            Button.width('45%');
            // 恢复数据按钮
            Button.height(44);
    ...
    buildManualOperations(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SyncSettings.ets(325:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor({ "id": 16777304, "type": 10001, params: [], "bundleName": "com.example.readerkitdemo", "moduleName": "entry" });
            Column.borderRadius(8);
            Column.shadow({ radius: 4, color: '#00000010', offsetX: 0, offsetY: 2 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('手动操作');
            Text.debugLine("entry/src/main/ets/pages/SyncSettings.ets(326:7)", "entry");
            Text.fontColor(Color.Black);
            Text.fontSize(18);
            Text.fontWeight(FontWeight.Medium);
            Text.margin({ bottom: 16 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SyncSettings.ets(332:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('导出数据', { type: ButtonType.Normal });
            Button.debugLine("entry/src/main/ets/pages/SyncSettings.ets(333:9)", "entry");
            Button.width('45%');
            Button.height(44);
            Button.backgroundColor('#FAAD14');
            Button.fontColor(Color.White);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SyncSettings.ets(344:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('导入数据', { type: ButtonType.Normal });
            Button.debugLine("entry/src/main/ets/pages/SyncSettings.ets(346:9)", "entry");
            Button.width('45%');
            Button.height(44);
