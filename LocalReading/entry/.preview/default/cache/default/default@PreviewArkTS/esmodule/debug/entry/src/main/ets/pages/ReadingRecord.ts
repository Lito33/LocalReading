...
class ReadingRecord extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(124:7)", "entry");
            // 标题栏
            Row.width('100%');
            // 标题栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(130:9)", "entry");
            Blank.layoutWeight(1);
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('阅读记录');
            Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(131:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(136:9)", "entry");
            Blank.layoutWeight(1);
        }, Blank);
        Blank.pop();
        // 标题栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(141:7)", "entry");
            Scroll.layoutWeight(1);
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(142:9)", "entry");
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //最近7天
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(144:11)", "entry");
            //最近7天
            Column.margin({ right: 10, left: 10 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('最近7天');
            Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(145:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.Black);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.recentBooks.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create({ space: 8 });
                        List.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(154:15)", "entry");
                        ...
                        const forEachItemGenFunction = _item => {
                            const book = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(156:19)", "entry");
                                };
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(168:15)", "entry");
                        Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 固定下半部分：之前
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(182:11)", "entry");
            // 固定下半部分：之前
            Column.margin({ right: 10, left: 10 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('之前');
            Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(183:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(Color.Black);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.olderBooks.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create({ space: 8 });
                        List.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(192:15)", "entry");
                        List.scrollBar(BarState.Off);
                        List.margin({ right: 8 });
                        List.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            const book = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(194:19)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.RecordItem.bind(this)(book);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(205:15)", "entry");
                        Text.fontSize(14);
                        Text.fontColor(Color.Gray);
                        Text.width('100%');
                        Text.textAlign(TextAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.recentBooks.length === 0 && this.olderBooks.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无阅读记录');
                        Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(220:13)", "entry");
                        Text.fontSize(16);
                        Text.fontColor(Color.Gray);
                        Text.margin({ top: 50 });
                    }, Text);
    ...
    RecordItem(book: BookParserInfo, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(238:5)", "entry");
            Row.width('100%');
            Row.height(80);
            Row.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //书名和章节
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(248:7)", "entry");
            //书名和章节
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(249:9)", "entry");
            Text.fontSize(16);
            Text.maxLines(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/ReadingRecord.ets(255:9)", "entry");
            Text.fontSize(14);
