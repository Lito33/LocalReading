...
class DebugStorage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/common/DebugStorage.ets(31:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('存储调试页面');
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(32:7)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('当前存储状态：');
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(37:7)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(42:7)", "entry");
            Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(46:7)", "entry");
            Text.fontSize(14);
            Text.margin({ bottom: 5 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(50:7)", "entry");
            Text.fontSize(14);
            Text.margin({ bottom: 5 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/common/DebugStorage.ets(54:7)", "entry");
            Text.fontSize(14);
            Text.margin({ bottom: 20 });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/common/DebugStorage.ets(58:7)", "entry");
            Button.width('80%');
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/common/DebugStorage.ets(67:7)", "entry");
            Button.width('80%');
            Button.height(40);
            Button.margin({ bottom: 10 });
            Button.onClick(async () => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/common/DebugStorage.ets(75:7)", "entry");
            Button.width('80%');
            Button.height(40);
            Button.margin({ bottom: 10 });
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/common/DebugStorage.ets(83:7)", "entry");
            Button.width('80%');
            Button.height(40);
            Button.onClick(() => {
                router.back();
