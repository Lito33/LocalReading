...
export class Mine extends ViewPU {
    ...
    customRefreshIndicator(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Mine.ets(197:5)", "entry");
            Column.width('95%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Refresh.debugLine("entry/src/main/ets/pages/Mine.ets(228:5)", "entry");
            // 使用Refresh组件包裹整个内容，并添加自定义下拉效果
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/Mine.ets(231:7)", "entry");
            Scroll.width('100%');
            Scroll.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Mine.ets(232:9)", "entry");
            Column.width('100%');
        }, Column);
        // 自定义下拉刷新指示器
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 10 });
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(236:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/Mine.ets(242:13)", "entry");
            Column.margin({ right: 25 });
            Column.justifyContent(FlexAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.isLoggedIn ? this.currentUser : "未登录");
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(243:15)", "entry");
            ...
            if (this.isLoggedIn) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/Mine.ets(249:17)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/Mine.ets(262:17)", "entry");
                        Button.width(this.isTablet() ? 120 : 100);
                        Button.borderRadius(8);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //阅读记录
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(286:9)", "entry");
            //阅读记录
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 7 });
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(287:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("阅读记录");
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(288:13)", "entry");
            Text.fontSize(this.getTitleFontSize());
            Text.fontColor(Color.Black);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //关于
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(330:9)", "entry");
            //关于
            Row.height(this.getRowHeight());
            //关于
            Row.width(this.getCardWidth());
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(331:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("关于");
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(332:13)", "entry");
            Text.fontSize(18);
            Text.fontColor(Color.Black);
            Text.fontWeight(FontWeight.Bold);
            Text.margin({ left: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //护眼模式
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(376:9)", "entry");
            //护眼模式
            Row.height(this.getRowHeight());
            //护眼模式
            Row.width(this.getCardWidth());
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("护眼模式");
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(378:11)", "entry");
            Text.fontSize(18);
            Text.fontColor(Color.Black);
            Text.fontWeight(FontWeight.Bold);
            Text.margin({ left: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //退出按钮
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Mine.ets(414:9)", "entry");
            //退出按钮
            Row.height(this.getRowHeight());
            //退出按钮
            Row.width(this.getCardWidth());
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create("退出应用");
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(415:11)", "entry");
            Text.fontSize(18);
            Text.fontColor(Color.Black);
            Text.fontWeight(FontWeight.Bold);
            Text.margin({ left: 10 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //调用接口，显示数
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Mine.ets(451:9)", "entry");
            //调用接口，显示数
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(453:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Mine.ets(463:11)", "entry");
            Text.fontWeight(FontWeight.Bold);
            Text.fontSize(14);
